...
public class Constants {
	//public static final String API = "https://api.ost.pt/";
	...
	public static final String queryTestNeg = "euro 2004 -moeda";
	
	public static final String queryTestExpression = " \"Stephen Hawking\" ";
